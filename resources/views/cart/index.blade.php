    ...
    <section id="cart">
                        ...
                        <div class="main-cart-item">
                            ...
                            <div class="text-cart">
                                ...
                                <div class="count-block" data-countProductId="{{$itemCart['id']}}">
                                    ...
                                    <input class="count-itemcart" type="number" value="{{$itemCart['quantity']}}">
        ...
        <div class="send-form">
            ...
            <div class="count-prod">
                <p>Товары(<span id="count-prod">{{isset($_COOKIE['cart_id']) ? \Cart::session($_COOKIE['cart_id'])->getTotalQuantity() : '0'}}</span>)</p>
                <p><span class="sup-price">{{\Cart::session($_COOKIE['cart_id'])->getSubTotal()}}</span> <sub>руб.</sub></p>
            </div>
            <div class="res-price">
                <p>Итого</p>
                <p><span class="sup-price">{{\Cart::session($_COOKIE['cart_id'])->getSubTotal()}}</span> <sub>руб.</sub></p>
